...
// netlify/functions/create-background-checks.js
"use strict";
...
var node_fetch_1 = __importDefault((init_src(), src_exports));
var handler = async (event) => {
  ...
  try {
    ...
    return {
      statusCode: ((_a4 = error.response) == null ? void 0 : _a4.status) || 500,
      headers,
      body: JSON.stringify({
 ...
 */
//# sourceMappingURL=create-background-checks.js.map
